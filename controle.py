...
## Import bibliotecas ##
from PyQt5 import uic, QtWidgets  # Biblioteca PYQT5
import mysql.connector  # Banco de dados
from reportlab.pdfgen import canvas  # Biblioteca importar PDF
...
# Função editar, editar dados de produtos já cadastrados
...
def editar_dados():
    ...
    tela_editar.lineEdit_7.setText(str(produto[0][0]))
    tela_editar.lineEdit_6.setText(str(produto[0][1]))
    tela_editar.lineEdit_5.setText(str(produto[0][2]))
    tela_editar.lineEdit_3.setText(str(produto[0][3]))
    tela_editar.lineEdit_2.setText(str(produto[0][4]))
    numero_id = valor_id


# Função salvar dados editados, salva os produtos depois de editados
def salvar_valor_editado():
    global numero_id

    # Ler dados do lineEdit
    codigo = tela_editar.lineEdit_6.text()
    descricao = tela_editar.lineEdit_5.text()
    preco = tela_editar.lineEdit_3.text()
    categoria = tela_editar.lineEdit_2.text()
...
# Tela inicial, cadastro de produtos
